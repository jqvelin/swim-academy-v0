...
import { vh, vw } from "@/lib/calculateViewport"
...
export default function Map(){
    ...
    <div className="w-[70%] flex flex-col gap-8 justify-between items-center">
      ...
      <ul className="text-start list-disc font-bold text-xl md:text-2xl lg:text-3xl">
        ...
        <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3A15b15df22de7216dd6af2ea839f89d4e350981a8a987d19b36b1e4930577e518&amp;source=constructor" width={vw(90)} height={vh(100)}></iframe> 
    </div>
    </section>
}